...
import DisplayPrice from '../common/Middle/DisplayPrice';
import ReturnIo from '../common/Middle/ReturnIo';
...
function Middle() {
    ...
    const ReturnEvent = () => dispatch(returnCoin());
    ...
    return (
        <MiddleWrap>
            ...
            <InsertBx>
                ...
                <ReturnIo returnEvent={ReturnEvent} drop={drop} />
            </InsertBx>
        </MiddleWrap>
    );
}
